...
#$ -l h_vmem=50G
#$ -pe gpu-titanx 1
#$ -o /exports/chss/eddie/ppls/groups/lel_hcrc_cstr_students/s1769454/train_log/fastpitch_train.stdout
#$ -e /exports/chss/eddie/ppls/groups/lel_hcrc_cstr_students/s1769454/train_log/fastpitch_train.stderr
#$ -M s1769454@ed.ac.uk
#$ -m beas
#
