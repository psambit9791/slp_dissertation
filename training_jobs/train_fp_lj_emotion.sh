...
#$ -l h_vmem=50G
#$ -pe gpu-titanx 1
#$ -o /exports/eddie/scratch/s1769454/train_log/fastpitch_train_fp_lj_emo.stdout
#$ -e /exports/eddie/scratch/s1769454/train_log/fastpitch_train_fp_lj_emo.stderr
#$ -M s1769454@ed.ac.uk
#$ -m beas
#
