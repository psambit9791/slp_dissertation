...
class PhonemeProcessing(object):
    def __init__(self):
        self.symbols = ['<pad>', 'AA', 'AW', 'DH', 'Y', 'HH', 'CH', 'JH', 'spn', 'ZH', 'EH', 'NG', '<.>', 'TH', '<uh>', '<,>', 'IY', '<!>', 'B', 'AE', 'D', 'G', 'F', 'AH', 'K', 'M', 'L', 'AO', 'N', 'IH', 'S', 'R', 'EY', 'T', 'W', 'V', 'AY', 'Z', '<?>', 'ER', 'P', 'UW', 'SH', 'UH', 'OY', 'OW', '<sp>']
