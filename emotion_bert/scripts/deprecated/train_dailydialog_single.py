...
def create_model_dir():
	folder = str(int(datetime.datetime.now().timestamp())) + "_dailydialog_single"
...
def load_from_pkl(mode, dataset):
    data = None
    with open(ROOT+"data/daily_dialog_single/pkl/"+mode+"_"+dataset+".pkl", "rb") as f:
        data = pickle.load(f)
    return data

def load_from_sent(mode, dataset):
    data = None
    with open(ROOT+"data/daily_dialog_single/sent/"+mode+"_"+dataset+".pkl", "rb") as f:
        data = pickle.load(f)
    return data
